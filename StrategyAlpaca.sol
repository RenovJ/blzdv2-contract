...
// File: contracts/interfaces/IAlpacaFarm.sol
...
// File: contracts/interfaces/IAlpacaToken.sol
...
// File: contracts/StrategyAlpaca.sol
...
contract StrategyAlpaca is Ownable, ReentrancyGuard, Pausable {
    ...
    bool public isxBLZDComp; // this vault is purely for staking. eg. WBNB-xBLZD staking vault.
    ...
    address[] public earnedToxBLZDPath;

    constructor(
        address _YetiMasterAddress,
        address _xBLZDAddress,
        bool _isxBLZDComp,
        ...
        xBLZDAddress = _xBLZDAddress;

        isxBLZDComp = _isxBLZDComp;
        ...
        if (isxBLZDComp) {
            ...
            earnedToxBLZDPath = [earnedAddress, wbnbAddress, xBLZDAddress];
            if (wbnbAddress == earnedAddress) {
                earnedToxBLZDPath = [wbnbAddress, xBLZDAddress];
            }
        }
    ...
    function _farm(uint256 _wantAmt) internal {
        ...
        IAlpacaFarm(farmContractAddress).deposit(address(this), pid, _wantAmt);
    }
    ...
    function earn() public whenNotPaused {
        require(isxBLZDComp, "!isxBLZDComp");
        if (onlyGov) {
